...
Funcion VerdaderoOfalso = comprobar(vectorA, vectorB, indiceAB)
	...
	contador = 0
	VerdaderoOfalso= Falso
	Mientras contador <> indiceAB-1 y vectorA(contador) = vectorB(contador) y VerdaderoOfalso=Falso
	
		contador= contador + 1
		
		si contador = inidiceAB Entonces
			contador= contador -1
			VerdaderoOfalso= Verdadero
		FinSi
	FinMientras
